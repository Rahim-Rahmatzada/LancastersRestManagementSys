...
public class RestaurantCapacityUI extends BaseUI {
    ...
    public RestaurantCapacityUI(UISwitcher uiSwitcher) {
        super(uiSwitcher);
        highlightButton("Restaurant Capacity");

        setTopText("Restaurant capacity Overviewwwwwwww");

        // Set the main content for the BookingsUI.
        VBox restaurantCapacityContent = new VBox();

        setMainContent(restaurantCapacityContent);
    }
